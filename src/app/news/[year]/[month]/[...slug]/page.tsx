...
export default function ArticlePage() {
  ...
  return (
    <article className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      {article.heroImage && (
        <div className="relative w-full h-[60vh] min-h-[500px] max-h-[700px] overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800">
          <Image
