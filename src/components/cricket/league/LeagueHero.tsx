...
export function CricketLeagueHero({ meta, nextFixture }: CricketLeagueHeroProps) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-emerald-700 via-slate-900 to-blue-900 text-white">
      ...
      <Container size="2xl" className="relative z-10 py-16">
        ...
        >
          <div className="space-y-5 max-w-2xl">
            ...
            <p className="text-lg text-emerald-100/80">{meta.description}</p>
            {meta.founded && (
          ...
          {nextFixture && (
            ...
            >
              <p className="text-xs uppercase tracking-wide text-emerald-200">Next Highlighted Match</p>
