      ...
      <div className="grid gap-4 p-4 md:grid-cols-2 xl:grid-cols-4">
        {leaders.map((leader) => (
          <div
            ...
            className="rounded-xl border border-gray-100 bg-gradient-to-br from-white via-white to-emerald-50/40 p-4 shadow-sm"
          >
            <div className="flex items-center gap-3">
              <img src={leader.crest} alt={leader.team} className="h-10 w-10 rounded-full bg-white p-1 shadow-inner" />
              <div>
                <p className="text-xs uppercase tracking-wide text-emerald-600">{metricLabels[leader.metric]}</p>
            ...
            <button className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-emerald-600 hover:text-emerald-500">
