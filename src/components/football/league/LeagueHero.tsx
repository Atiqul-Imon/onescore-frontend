...
export function LeagueHero({ meta, nextFixture }: LeagueHeroProps) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-primary-800 text-white">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          {nextFixture && (
            <div className="w-full max-w-md rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur-sm">
              <p className="text-xs uppercase tracking-wide text-primary-200">Next Highlighted Fixture</p>
